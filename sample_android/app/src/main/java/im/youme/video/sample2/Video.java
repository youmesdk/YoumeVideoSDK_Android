...
//        sessionid_edittext1.setKeyListener(DigitsKeyListener.getInstance(digists));
    ...
    private void SelectionPosition(int position) {
        ...
        switch (position) {
            case 0:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_DEFAULT_SERVER;
                break;

            case 1:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_CN_SERVER;
                break;
            case 2:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_SG_SERVER;
                break;
            case 3:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_HK_SERVER;
                break;
            case 4:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_US_SERVER;
                break;
            case 5:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_DE_SERVER;
                break;
            case 6:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_JP_SERVER;
                break;
            case 7:
                choosedServerRegion = YouMeConst.YOUME_RTC_SERVER_REGION.RTC_KR_SERVER;
                break;
            default:
